...
public class Graphique {
	...
	bs = new BoiteSelection(new Rectangle(MG2D.Couleur.GRIS_CLAIR, new Point(0, 0), new Point(640, TAILLEY), true), pointeur);
	//f.ajouter(bs.getRectangle());
	//System.out.println(tableau[pointeur.getValue()].getChemin());
	bi = new BoiteImage(new Rectangle(MG2D.Couleur.GRIS_FONCE, new Point(640, 512), new Point(TAILLEX, TAILLEY), true), new String(tableau[pointeur.getValue()].getChemin()));
	//f.ajouter(bi.getRectangle());
	bd = new BoiteDescription(new Rectangle(MG2D.Couleur.GRIS, new Point(640, 0), new Point(TAILLEX, 512), true));
	...
	if (new File("img/fondretro3.png").exists()) {
		f.ajouter(fond);
	}
	...
	for(int i = 0 ; i < tableau.length ; i++){
	    ...
	    tableau[i].getTexte().setCouleur(MG2D.Couleur.BLANC);
	}
	//add texture
	...
	f.ajouter(new Ligne(MG2D.Couleur.NOIR,new Point(670,360), new Point(1250,360)));
	f.ajouter(new Ligne(MG2D.Couleur.NOIR,new Point(670,190), new Point(1250,190)));
	f.ajouter(new Ligne(MG2D.Couleur.NOIR,new Point(960,210), new Point(960,310)));
    ...
    public void selectionJeu(){	
		...
		Rectangle boutonNon = new Rectangle(MG2D.Couleur.ROUGE, new Point(340, 600), 200, 100, true);
		Rectangle boutonOui = new Rectangle(MG2D.Couleur.VERT, new Point(740, 600), 200, 100, true);
		Texte message = new Texte(MG2D.Couleur.NOIR, "Voulez vous vraiment quitter ?", font, new Point(640, 800));
		Texte non = new Texte(MG2D.Couleur.NOIR, "NON", font, new Point(440, 650));
		Texte oui = new Texte(MG2D.Couleur.NOIR, "OUI", font, new Point(840, 650));
		Rectangle rectSelection = new Rectangle(MG2D.Couleur.BLEU, new Point(330,590),220,120, true);
		int frame=0;
